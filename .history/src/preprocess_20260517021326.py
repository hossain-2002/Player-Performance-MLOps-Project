...
def prepare_dataframe(df: pd.DataFrame) -> Tuple[pd.DataFrame, LabelEncoder, LabelEncoder]:
    ...
    if gk_cols:
        outfield = outfield.drop(columns=gk_cols)
    ...
    for col in numeric_cols:
        ...
        outfield[col] = outfield[col].fillna(median)
